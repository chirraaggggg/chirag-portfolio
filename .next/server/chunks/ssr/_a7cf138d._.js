module.exports = [
"[project]/src/components/scramble-text.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$scramble$2f$dist$2f$use$2d$scramble$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/use-scramble/dist/use-scramble.esm.js [app-ssr] (ecmascript)");
"use client";
;
;
function ScrambleText({ text, className = "", speed = 0.5, tick = 1, step = 1, scramble = 5, seed = 3 }) {
    const { ref } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$scramble$2f$dist$2f$use$2d$scramble$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useScramble"])({
        text,
        speed,
        tick,
        step,
...
"[project]/node_modules/use-scramble/dist/use-scramble.esm.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var useScramble = function useScramble(props) {
    ...
    var prefersReducedMotion = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : false;
    ...
    var rafRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    // compute
    var elapsedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    var fpsInterval = 1000 / (60 * speed);
    // scramble step
    var stepRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    // current character index ref
    var scrambleIndexRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    // scramble controller
    var controlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])([]);
    // overdrive control index
    var overdriveRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
...
//# sourceMappingURL=_a7cf138d._.js.map